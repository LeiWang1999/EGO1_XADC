...
HD_PWD='D:/EELab/FPGA/HomeWork/EGO1_XADC_DEMO/EGO1_XADC_DEMO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MyA2D_SingleChannel_05_ContinousMode.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MyA2D_SingleChannel_05_ContinousMode.tcl -notrace
