...
HD_PWD='D:/EELab/FPGA/HomeWork/EGO1_XADC_DEMO/EGO1_XADC_DEMO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MyA2D_SingleChannel_05_ContinousMode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MyA2D_SingleChannel_05_ContinousMode.tcl
